...
% Figure locations relative to main.tex in the repository root.  Keeping the
% generated files in their analysis-output directories allows a GitHub-linked
% Overleaf project to compile without copying or renaming figures.
\graphicspath{{visualization var threshold0.4/figures/}%
              {visualization var threshold0.4/figures/population detail/}%
              {assessment_var/feature_importance_analysis/reader_figures/}}
\newcommand{\projectfigure}[2][]{\includegraphics[#1]{#2}}
\usepackage{booktabs}
